...
public abstract class Actor extends TypedAtomicActor implements IMessageCreator {
	...
	/**
	 * Flag indicating that the actor is in a paused state, 
	 * as a consequence of a pause() call.
	 * In this state, its iteration cycle has been halted,
	 * and will only continue after a resume() has been done.
	 */
