...
class AddUserLibraryFolderAction extends FigureAction {

    private ModelGraphPanel panel;

	public AddUserLibraryFolderAction(ModelGraphPanel panel) {
        super("Add folder");
        this.panel = panel;
    }
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        if(target instanceof EntityLibrary) {
        	...
        	new AddFolderToLibraryDialog(getFrame(), panel.getConfiguration(), lib);
        }
    }
}