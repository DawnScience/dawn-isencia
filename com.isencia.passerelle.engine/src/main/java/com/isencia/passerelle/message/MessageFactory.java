...
public class MessageFactory {
    ...
    /**
     * Create a new msg and set addition header info.
     * The headerProps map should contain string keys, matching the ManagedMessage.SystemHeader constants,
     * and string values. Any other entries are ignored.
     * 
     * HEADER_ID, HEADER_VERSION, HEADER_TIMESTAMP_CREATION can not be overwritten though.
     * 
     * @param headerProps
     * @return
     */
    ...
    /**
     * Set the given header properties.
     * HEADER_ID, HEADER_VERSION, HEADER_TIMESTAMP_CREATION can not be overwritten though.
     * @param newMsg
     * @param headerProps
     */
