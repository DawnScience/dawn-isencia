...
/**
 * The contract for messages that are managed by the Passerelle suite.
 * Managed messages have a number of predefined header fields, and some ways
 * to manage content/payload.
 * 
 * @author erwin
 */
public interface ManagedMessage extends Serializable {
    ...
    public class SystemHeader {
        ...
        /**
         * MANDATORY header used to identify the source via which the message entered into the system,
         * or the actor that created the message inside the system.
         * 
         * Values are typically descriptive strings identifying system components,
         * e.g. a concatenation of the model name and the actor name.
         * 
         * Will normally be a single-valued header.
         */
        public final static String HEADER_SOURCE_REF = "__PSRL_SRC_REF";
        /**
         * OPTIONAL header used to maintain additional source info.
         * Typically contains e.g. a URL for a file reader, mail-box for a mail reader etc.
         * 
         * Can be a multi-valued header.
         */
        public final static String HEADER_SOURCE_INFO = "__PSRL_SRC_INFO";
        /**
         * MANDATORY header used to maintain a unique ID assigned to the message upon entering
         * the system.
         * 
         * Will normally be a single-valued header.
         */
        ...
        /**
         * OPTIONAL header used to maintain a correlation ID, that can be used by a matcher-component
         * to correlate this message to another message.
         * This is typically used to implement request/reply semantics in a message-based system.
         * 
         * Will normally be a single-valued header.
         */
        public final static String HEADER_CORRELATION_ID = "__PSRL_CORRELATION_ID";
        /**
         * OPTIONAL header used to maintain a reference to a message sequence 
         * to which this message belongs. 
         * 
         * E.g. for a file-reader, the complete set of messages
         * generated for reading one file will be generated in a sequence.
         * 
         * Single-valued.
         */
        ...
        /**
         * OPTIONAL header that indicates whether the message is the last one
         * in the sequence.
         * 
         * Single-valued.
         */
        ...
        /**
         * OPTIONAL header used to maintain references to other messages that are 
        ...
        /**
         * MANDATORY header used to maintain the timestamp of the moment that the message
         * was received in the system, or when it was generated inside the system.
         * 
         * Messages created by the system, i.e. not coming from a source actor,
         * should normally maintain a reference to a preceeding/causing message in the
         * HEADER_CAUSES_REFS header. 
         * 
         * This is a single-valued header.
         */
        public final static String HEADER_TIMESTAMP_CREATION = "__PSRL_TIMESTAMP_CREATION";
        /**
         * MANDATORY header used to maintain the version nr of the message, i.e. an indicator
         * about how many times the message was modified inside the system.
         * 
         * This is a single-valued header.
         */
        public final static String HEADER_VERSION = "__PSRL_VERSION";
        /**
         * MANDATORY header used to maintain the audit trail of the flow that the message followed
         * in the system.
         * 
         * This is a multi-valued header, where each entry contains a timestamp and an actor reference.
         * The method <code>MessageContainer.addAuditTrail()</code> should preferably be used, in order
         * to obtain a standard formatting of the audit-trail entries.
         */
