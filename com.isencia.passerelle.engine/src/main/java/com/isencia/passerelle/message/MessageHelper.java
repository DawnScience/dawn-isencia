...
public class MessageHelper {
    ...
    /**
     * Get the content dispostion of a part. The part is interogated for a valid content disposition. If the content disposition is missing, a default
     * disposition is created based on the type of the part.
     * 
     ...
     * @see javax.mail.Part
     */
    static ContentDisposition getContentDisposition(Part part)
     ...
     * @param typeFilter 
     * 
     * @return an array containing strings from the message parts matching one of the 
     * given content types
     */
     ...
     */
    public static ManagedMessage getMessage(IOPort input)
                                       throws PasserelleException {
        if (logger.isTraceEnabled()) {
     ...
     * @throws PasserelleException 
     */
    public static String getMessageAsString(IOPort input)
                                     throws PasserelleException {
        if (logger.isTraceEnabled()) {
            logger.trace(input.getDisplayName());		// TODO Check if correct converted
        }
     ...
     */
    public static Token getMessageAsToken(IOPort input)
                                   throws PasserelleException {
        if (logger.isTraceEnabled()) {
            logger.trace(input.getDisplayName());		// TODO Check if correct converted
        }
     ...
     * @throws MessagingException DOCUMENT ME!
     */
    public static void copyHeaders(Part part, Part newPart)
                            throws MessagingException {
     ...
     */
    public static String getPrimaryContentType(ManagedMessage message)
                                     throws MessageException {
        try {
	 ...
	 * @throws MessagingException
     */
    public static String getSubContentType(ManagedMessage message)
                                 throws MessageException {
        try {
			ContentType type = new ContentType(message.getBodyContentType());
