...
public class TokenHelper {
	...
	public static String getStringFromToken(Token token) throws PasserelleException {
		...
		if( token!=null) {
			try {
				...
				throw new PasserelleException("Error building String from token", token, e);
			}
		}
	...
	public static Integer getIntegerFromToken(Token token) throws PasserelleException {
		...
		if( token!=null) {
			try {
				if (token instanceof ObjectToken) {
					...
					if(obj instanceof Integer) {
						...
						try {
							...
							throw new PasserelleException("Invalid Integer format",token,e);
						}
					}
				} else {
					if (token instanceof StringToken) {
						...
						try {
							...
							try {
								...
								throw new PasserelleException("Invalid token for obtaining Integer value",token,e1);
							}
						}
					} else {
				...
				throw new PasserelleException("Error building Integer from token", token, e);
			}
		}
     ...
     * </ul>
     * 
     * Remark that converting a integer to a short may lead to loss of precision and/or of most-significant bytes.
     * The result can be that a big integer value gets converted into some negative short value.
     * 
     * @param token
     * @return
     */
	public static Short getShortFromToken(Token token) throws PasserelleException {
		...
		if( token!=null) {
			try {
				if (token instanceof ObjectToken) {
					...
					if(obj instanceof Short) {
						...
						try {
							...
							throw new PasserelleException("Invalid Short format",token,e);
						}
					}
				} else {
					if (token instanceof StringToken) {
						...
						try {
							...
							try {
								...
								// not even doubleValue is supported...
								throw new PasserelleException("Invalid token for obtaining Short value",token,e1);
							}
						}
					} else {
				...
				throw new PasserelleException("Error building Short from token", token, e);
			}
		}
	...
	public static Complex getComplexFromToken(Token token) throws PasserelleException {
		...
		if( token!=null) {
			try {
				if (token instanceof ObjectToken) {
					...
					if(obj instanceof Complex) {
		                ...
		                try {
		                	...
		                	try {
								...
								throw new PasserelleException("Invalid Complex format",token,e1);
		                	}
		                }
					}
				} else {
					if (token instanceof StringToken) {
						...
						try {
							...
							throw new PasserelleException("Invalid token for obtaining Complex value",token,e);
						}
					} else {
				...
				throw new PasserelleException("Error building Complex from token", token, e);
			}
		}
	...
	public static Double getDoubleFromToken(Token token) throws PasserelleException {
		...
		if( token!=null) {
			try {
				if (token instanceof ObjectToken) {
					...
					if(obj instanceof Double) {
						...
						try {
							...
							throw new PasserelleException("Invalid Double format",token,e);
						}
					}
				} else {
					if (token instanceof StringToken) {
						...
						try {
							...
							throw new PasserelleException("Invalid token for obtaining Double value",token,e);
						}
					} else {
				...
				throw new PasserelleException("Error building Double from token", token, e);
			}
		}
     ...
     * </ul>
     * 
     * Remark that converting a double to a float may lead to loss of precision.
     * Furthermore, if the double value in the token is bigger than Float.MAX_VALUE,
     * the converted float will just be "infinity".
     * 
     * @param token
     * @return
     */
	public static Float getFloatFromToken(Token token) throws PasserelleException {
		...
		if( token!=null) {
			try {
				if (token instanceof ObjectToken) {
					...
					if(obj instanceof Float) {
						...
						try {
							...
							throw new PasserelleException("Invalid Float format",token,e);
						}
					}
				} else {
					if (token instanceof StringToken) {
						...
						try {
							...
							throw new PasserelleException("Invalid token for obtaining Float value",token,e);
						}
					} else {
				...
				throw new PasserelleException("Error building Float from token", token, e);
			}
		}
	...
	public static Boolean getBooleanFromToken(Token token) throws PasserelleException {
		...
		if( token!=null) {
			try {
				if (token instanceof ObjectToken) {
					...
					if(obj instanceof Boolean) {
						...
						try {
							...
							throw new PasserelleException("Invalid Boolean format",token,e);
						}
					}
				} else {
					if (token instanceof StringToken) {
				...
				throw new PasserelleException("Error building Boolean from token", token, e);
			}
		}
	...
	public static Byte getByteFromToken(Token token) throws PasserelleException {
		...
		if( token!=null) {
			try {
				if (token instanceof ObjectToken) {
					...
					if(obj instanceof Byte) {
						...
						try {
							...
							throw new PasserelleException("Invalid Byte format",token,e);
						}
					}
				} else {
					if (token instanceof StringToken) {
				...
				throw new PasserelleException("Error building Byte from token", token, e);
			}
		}
