...
public class JDayChooserBeanInfo extends SimpleBeanInfo {
  ...
  public JDayChooserBeanInfo() {
    icon = loadImage("be.isencia.util.swing.images/JDayChooserColor16.gif");
    icon32 = loadImage("be.isencia.util.swing.images/JDayChooserColor32.gif");
    iconM = loadImage("be.isencia.util.swing.images/JDayChooserMono16.gif");
    icon32M = loadImage("be.isencia.util.swing.images/JDayChooserMono32.gif");
  }
  ...
  public PropertyDescriptor[] getPropertyDescriptors() {
    try {
      if (PropertyEditorManager.findEditor(Locale.class) == null) {
        BeanInfo beanInfo = Introspector.getBeanInfo(JPanel.class); // Thanks to
        // Andreas
        // Wollschlaeger
