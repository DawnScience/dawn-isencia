...
public class JYearChooserBeanInfo extends SimpleBeanInfo {
  ...
  public JYearChooserBeanInfo() {
    icon = loadImage("be.isencia.util.swing.images/JYearChooserColor16.gif");
    icon32 = loadImage("be.isencia.util.swing.images/JYearChooserColor32.gif");
    iconM = loadImage("be.isencia.util.swing.images/JYearChooserMono16.gif");
    icon32M = loadImage("be.isencia.util.swing.images/JYearChooserMono32.gif");
  }
