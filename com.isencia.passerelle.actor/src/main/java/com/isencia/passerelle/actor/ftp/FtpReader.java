 ...
 * @author Bram
 */
public class FtpReader extends TriggeredChannelSource {
   ...
   *              with this name.
   */
  public FtpReader(CompositeEntity container, String name) throws IllegalActionException, NameDuplicationException {
