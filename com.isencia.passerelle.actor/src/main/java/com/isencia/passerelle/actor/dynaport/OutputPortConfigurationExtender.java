...
/**
 * An OutputPortBuilder that is implemented as a ConfigurationExtender,
 * i.e. by adding a parameter on the containing entity, to define the names
 * of the desired/required output ports.
 * 
 * @author delerw
 *
 */
public class OutputPortConfigurationExtender extends OutputPortBuilder implements ConfigurationExtender, ValueListener {
