...
/**
 * Options factory for request/reply SocketServer actors
 * 
 * @author erwin
 */
public class SocketSvrReqReplierOptionsFactory extends OptionsFactory {
   ...
   */
  public SocketSvrReqReplierOptionsFactory(Actor container, String name) throws IllegalActionException, NameDuplicationException {
